 ...
 * @author oscar_o31
 */
public class Medicosver extends javax.swing.JFrame {

    /**
     * Creates new form Medicosver
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar medicos");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 171, 920, -1));
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(672, 612, 140, 50));
        ...
        jPanel1.add(jrbNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 60, -1, -1));

        jrbCodigo.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jrbCodigo.setSelected(true);
        jrbCodigo.setText("Codigo");
        jPanel1.add(jrbCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 20, -1, -1));
        ...
        jPanel1.add(jbtMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 100, 240, 50));
        ...
        if(jrbNombre.isSelected() == false && jrbCodigo.isSelected() == false){
            ...
            if(jrbNombre.isSelected() == true && jrbCodigo.isSelected() == true){
                ...
                if(Character.isDigit(k)){
                    ...
                    try{
                        ResultSet rs = bd.Vertodo("select * from Medicos where Nombre_me like'"+nombre+"%'");
                        DefaultTableModel model = new DefaultTableModel();
                        jtTabla.setModel(model);
                        model.setColumnIdentifiers(new Object[]{"Codigo del Medico", "Nombre", "Apellido", "Fecha del registro", "Telefono", "Contraseña", "Categoria"});
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String report = "src\\Medicos\\Medicos.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Medicosver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Medicosver().setVisible(true);
            }
        });
    }
