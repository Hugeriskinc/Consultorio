 ...
 * @author oscar_o31
 */
public class Recetasver extends javax.swing.JFrame {

    /**
     * Creates new form Recetasver
     */
    ...
    public Recetasver() {
        ...
        model.setColumnIdentifiers(new Object[]{"Codigo de la receta","Nombre del pacientes","Nombre del medico", "Fecha"});
        try{

            while(rs.next()){

                model.addRow(new Object[]{rs.getInt("Id_receta"), rs.getString("Nombre_pa"), rs.getString("Nombre_me"), rs.getString("Fecha_registro")});
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 620, 140, 50));
        jPanel1.add(jtxtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 210, 30));
        ...
        jPanel1.add(jbtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 150, 50));
        ...
        jPanel1.add(jrbNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 50, 200, -1));

        jrbCodigo.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jrbCodigo.setSelected(true);
        jrbCodigo.setText("Codigo");
        jPanel1.add(jrbCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 10, 200, -1));
        ...
        jPanel1.add(jbtMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 100, 230, 50));
        ...
        if(jrbNombre.isSelected() == false && jrbCodigo.isSelected() == false){
            ...
            if(jrbNombre.isSelected() == true && jrbCodigo.isSelected() == true){
                ...
                if(Character.isDigit(k)){
                    ...
                    ResultSet rs = bd.Vertodo("select * from recetas where Nombre_pa like'"+nombre+"%'");
                    DefaultTableModel model = new DefaultTableModel();
                    jtTabla.setModel(model);
                    model.setColumnIdentifiers(new Object[]{"Codigo de la receta","Nombre del pacientes","Nombre del medico", "Fecha"});
                    try{
            ...
            if(nombre.equals("")){
                ...
                try{
                    ...
                    if(ho > 0){
                        ResultSet rs = bd.Vertodo("select * from Recetas where Id_receta = "+nombre+"");
                        DefaultTableModel model = new DefaultTableModel();
                        jtTabla.setModel(model);
                        model.setColumnIdentifiers(new Object[]{"Codigo de la receta","Nombre del pacientes","Nombre del medico", "Fecha"});
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String report = "src\\Recetas\\Recetas.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Recetasver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Recetasver().setVisible(true);
            }
        });
    }
