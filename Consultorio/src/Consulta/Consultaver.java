...
public class Consultaver extends javax.swing.JFrame {
    ...
    public Consultaver() {
        initComponents();
            ...
            ResultSet rs = bd.Vertodo("select * from Consultas");
            DefaultTableModel model = new DefaultTableModel();
            jtTabla.setModel(model);
            model.setColumnIdentifiers(new Object[]{"Codigo de la consulta","Nombre pacientes","Nombre medicos", "Sintomas 1", "Sintomas 2", "Sintomas 3", "Sintomas 4","Sintomas 5", "Libras", "Respiracion", "Observacion", "Fecha de la consulta"});
            

                while(rs.next()){

                    model.addRow(new Object[]{rs.getInt("id_consulta"), rs.getString("nombre_pa"), rs.getString("nombre_me"), rs.getString("Sintomas1"), rs.getString("Sintomas2"), rs.getString("Sintomas3"), rs.getString("Sintomas4"), rs.getString("Sintomas5"), rs.getString("Libras"), rs.getString("Respiracion"), rs.getString("Observacion"), rs.getString("Fecha_registro")});
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 171, 1080, -1));
        ...
        jPanel1.add(jbtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 100, 150, 50));

        jrbNombre.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jrbNombre.setText("Nombre Pacientes");
        jPanel1.add(jrbNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 60, -1, -1));

        jrbCodigo.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jrbCodigo.setSelected(true);
        jrbCodigo.setText("Codigo Consulta");
        jPanel1.add(jrbCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 20, -1, -1));
        ...
        jPanel1.add(jbtMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 220, 50));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 100, 150, 50));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/textura.png"))); // NOI18N
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1110, 680));
        ...
        if(jrbNombre.isSelected() == false && jrbCodigo.isSelected() == false){
            ...
            if(jrbNombre.isSelected() == true && jrbCodigo.isSelected() == true){
                ...
                if(Character.isDigit(k)){
                    ...
                    try{
                    ResultSet rs = bd.Vertodo("select * from Consultas where nombre_pa like'"+nombre+"%'");
                    DefaultTableModel model = new DefaultTableModel();
                    jtTabla.setModel(model);
                    model.setColumnIdentifiers(new Object[]{"Codigo de la consulta","Nombre pacientes","Nombre medicos", "Sintomas 1", "Sintomas 2", "Sintomas 3", "Sintomas 4","Sintomas 5", "Libras", "Respiracion", "Observacion", "Fecha de la consulta"});
            ...
            if(nombre.equals("")){
                ...
                try{
                    ...
                    if(ho > 0){
                        ResultSet rs = bd.Vertodo("select * from Consultas where id_consulta = "+nombre+"");
                        DefaultTableModel model = new DefaultTableModel();
                        jtTabla.setModel(model);
                        model.setColumnIdentifiers(new Object[]{"Codigo de la consulta","Nombre pacientes","Nombre medicos", "Sintomas 1", "Sintomas 2", "Sintomas 3", "Sintomas 4","Sintomas 5", "Libras", "Respiracion", "Observacion", "Fecha de la consulta"});
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String report = "src\\Consulta\\Consulta.jrxml";
