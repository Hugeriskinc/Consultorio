 ...
 * @author oscar_o31
 */
public class Pacientesver extends javax.swing.JFrame {

    /**
     * Creates new form Pacientesver
     */
    ...
    public Pacientesver() {
        ...
        ResultSet rs = cc.Vertodo("select * from Pacientes");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 171, 950, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 610, 140, 50));
        jPanel1.add(jtxtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 210, 30));
        ...
        jPanel1.add(jbtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 100, 160, 50));

        jrbNombre.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jrbNombre.setText("Nombre");
        jPanel1.add(jrbNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 70, -1, -1));

        jrbCodigo.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jrbCodigo.setSelected(true);
        jrbCodigo.setText("Codigo");
        jPanel1.add(jrbCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 30, -1, -1));
        ...
        jPanel1.add(jbtMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 100, 240, 50));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 100, 150, 50));
        ...
        if(jrbNombre.isSelected() == false && jrbCodigo.isSelected() == false){
            ...
            if(jrbNombre.isSelected() == true && jrbCodigo.isSelected() == true){
                ...
                if(Character.isDigit(k)){
                    ...
                    ResultSet rs = bd.Vertodo("select * from Pacientes where Nombre_pa like'"+nombre+"%'");
                    DefaultTableModel model = new DefaultTableModel();
                    jtTabla.setModel(model);
                    model.setColumnIdentifiers(new Object[]{"Codigo del Paciente", "Nombre", "Apellido", "Edad", "Sexo", "Cedula", "Telefono", "Fecha de nacimiento", "Seguro", "Fecha del regristro"});
                    try{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String report = "src\\Pacientes\\Pacientes.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pacientesver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pacientesver().setVisible(true);
            }
        });
    }
    ...
    Conectar_Mysql cc = new Conectar_Mysql();
