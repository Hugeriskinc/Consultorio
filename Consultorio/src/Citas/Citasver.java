 ...
 * @author oscar_o31
 */
public class Citasver extends javax.swing.JFrame {

    /**
     * Creates new form Citasver
     */
    ...
    public Citasver() {
        ...
        model.setColumnIdentifiers(new Object[]{"Codigo del Citas","Nombre del paciente", "Nombre del doctor", "Fecha del registro"});
        try{
            ResultSet rs = bd.Vertodo("select * from Citas");

            while(rs.next()){

                model.addRow(new Object[]{rs.getString("id_citas"), rs.getString("Nombre_pa"), rs.getString("Nombre_me"), rs.getString("fecha")});
    ...
    private void initComponents() {
        ...
        jdReporte.setMinimumSize(new java.awt.Dimension(846, 522));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 480, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 171, 890, -1));
        ...
        jPanel1.add(jrbCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 30, -1, -1));
        ...
        jPanel1.add(jbtMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 230, 50));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 920, 680));
        ...
        String nombre = jtxtBuscar.getText();
            if(nombre.equals("")){
                ...
                try{
                    ...
                    if(ho > 0){
                        ResultSet rs = bd.Vertodo("select * from Citas where id_citas = "+nombre+"");
                        DefaultTableModel model = new DefaultTableModel();
                        jtTabla.setModel(model);
                        model.setColumnIdentifiers(new Object[]{"Codigo del Citas","Nombre del paciente", "Nombre del doctor", "Fecha del registro"});
                        while(rs.next()){
    ...
    //Boton para mostrar todas las citas
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String report = "src\\Citas\\report2Oracle.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Citasver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
